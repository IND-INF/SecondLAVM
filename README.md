...
### Функція „computeLoss“.
Функція „computeLoss“ принимаетъ на входъ векторы-строки ожидаемыхъ отвѣтовъ $y$ и полученныхъ предсказаній $\hat{y}$, оба длинною $m$. Потери считаются какъ $-\frac{1}{m}\sum_{i=1}^{m}[y_{i}ln\hat y_{i}+(1-y_{i})ln(1-\hat{y}_{i})]$.
